...
import com.submission.appriori.adapter.Itemset11Adapter.ViewHolder.Companion.DIFF_CALLBACK11
import com.submission.appriori.adapter.Itemset21Adapter.ViewHolder.Companion.DIFF_CALLBACK12
import com.submission.appriori.adapter.Itemset31Adapter.ViewHolder.Companion.DIFF_CALLBACK13
import com.submission.appriori.adapter.ItemsetAssoc1Adapter.ViewHolder.Companion.DIFF_CALLBACK14
import com.submission.appriori.adapter.ResultFinalAdapter.ViewHolder.Companion.DIFF_CALLBACK15
...
import com.submission.appriori.ui.report.ResultDetailActivity
import com.submission.appriori.utils.DateConvert
import com.submission.appriori.R
import com.submission.appriori.databinding.ItemReportBinding
...
import com.submission.appriori.databinding.ItemResultFinalBinding
        ...
        fun bind(itemsetassoc: AssociationRule) {
            with(binding) {
                with(binding) {
                    ...
                    tvLift.text =  (itemsetassoc.lift?.let { Math.round(it.times(100)) }
                        ?.div(100.0)).toString()
